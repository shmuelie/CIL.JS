...
(function (CIL) {
    ...
    (function (Tests) {
        ...
        QUnit.test("round trip", function (assert) {
            ...
            var i = Integer.fromBytes(value, Bitness.bit32);
            var comp = i.toBytes();
        ...
        QUnit.test("byte array to bit array", function (assert) {
            ...
            var i = Integer.fromBytes(bytes, Bitness.bit32);
        ...
        QUnit.test("to number", function (assert) {
            var bytes = [0x07, 0x5B, 0xCD, 0x15];
            var int = Integer.fromBytes(bytes, Bitness.bit32);
        ...
        QUnit.test("from number", function (assert) {
            var int = Integer.fromNumber(123456789, Bitness.bit32);
        ...
        QUnit.test("addition", function (assert) {
            ...
            var int1 = Integer.fromBytes(bytes1, Bitness.bit32);
            var int2 = Integer.fromBytes(bytes2, Bitness.bit32);
        ...
        QUnit.test("negate", function (assert) {
            var bytes = [0x07, 0x5B, 0xCD, 0x15];
            var int1 = Integer.fromBytes(bytes, Bitness.bit32);
