    ...
    (function (Runtime) {
        (function (_MemoryAssembly) {
            ...
            function readDataDirectory(reader) {
                var section = new _MemoryAssembly.Section();
            ...
            var MemoryAssembly = (function () {
                function MemoryAssembly(reader) {
                    ...
                    this.module = new _MemoryAssembly.Module();
            ...
            _MemoryAssembly.MemoryAssembly = MemoryAssembly;
